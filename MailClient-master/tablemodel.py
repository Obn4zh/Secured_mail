...
class TableModel(QtCore.QAbstractTableModel):
    def __init__(self, parent=None):
        ...
        self.mail = []  # Здесь хранится список писем
        self.rowCountMail = 0  # Количество строк
    ...
    def clear_data(self):
        ...
        self.beginResetModel()
        self.mail = []  # Очищаем список писем
        self.rowCountMail = 0  # Сбрасываем количество строк
        self.endResetModel()
