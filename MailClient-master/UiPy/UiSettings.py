...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.gridLayout.addWidget(self.cb_ssl, 6, 0, 1, 2)
        ...
        self.keyServer = QtWidgets.QLineEdit(Dialog)
        self.keyServer.setObjectName("keyServer")
        self.gridLayout.addWidget(self.keyServer, 5, 0, 1, 1)
        self.CAserver = QtWidgets.QLineEdit(Dialog)
        self.CAserver.setObjectName("CAserver")
        self.gridLayout.addWidget(self.CAserver, 5, 1, 1, 1)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_5.setText(_translate("Dialog", "Адрес сервера открытых ключей"))
        self.label_6.setText(_translate("Dialog", "Адрес сервера CA"))
